      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md mb-8">
          ...
          <div className="p-4 border-t border-gray-200">
            <Link href="/orders" className="text-blue-600 hover:text-blue-900 text-sm font-medium">
              عرض جميع الطلبات
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md">
          ...
          <div className="p-6">
            ...
            <div className="mt-4">
              <Link href="/products" className="text-blue-600 hover:text-blue-900 text-sm font-medium">
                إدارة المنتجات
              </Link>
            </div>
          </div>
